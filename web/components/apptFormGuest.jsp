            ...
            <div class="col-lg-6">
                <div class="appointment-form h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    <form action="core" method="post">
                        <div class="row g-3">
                            <input type="hidden" name="action" value="GUEST_BOOK_APPOINTMENT">

                            <div class="col-12 col-sm-6">
                                <input type="text" class="form-control bg-light border-0" style="height: 55px;" name="guestName" id="guestName" placeholder="Your Name" required>
                            </div>
                            <div class="col-12 col-sm-6">
                                <input type="email" class="form-control bg-light border-0" style="height: 55px;" name="guestEmail" id="guestEmail" placeholder="Your Email" required>
                            </div>
                            <div class="col-12 col-sm-6">
                                <input type="tel" class="form-control bg-light border-0" style="height: 55px;" name="guestMobile" id="guestMobile" placeholder="Your Mobile (10 digits)" pattern="[0-9]{10}" required>
                            </div>
