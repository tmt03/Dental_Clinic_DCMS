...
<html lang="en">
    ...
    <body>
        ...
        <div class="form-container">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <input type="hidden" id="appointmentID" name="appointmentID" value="${result.appointmentID}">
                    <td>
                        <input type="hidden" name="id" value="${result.resultID}" />
                        <input type="text" name="createTime" value="${result.createTime}" required />
                    </td>
                    <td>
                        <input type="text" name="doctor" value="${result.doctor}" required />
                    </td>
                    <td>
                        <input type="text" name="patient" value="${result.patient}" required />
                    </td>                        
                    <td>
                        <input type="text" name="description" value="${result.description}" required />
                    </td>
                    <td>
                        ...
                        <form action="viewAndUpdateMedicine" method="get">
                    ...
                    <td>
                        <input type="hidden" name="id" value="${result.resultID}" />
                        <input type="text" name="createTime" value="${result.createTime}" required readonly/>
                    </td>
                    <td>
                        <input type="text" name="doctor" value="${result.doctor}" required readonly/>
                    </td>
                    <td>
                        <input type="text" name="patient" value="${result.patient}" required readonly/>
                    </td>                        
                    <td>
                        <input type="text" name="description" value="${result.description}" required readonly/>
                    </td>
                    <td>
                        </form>
                        ...
                        <form action="viewAndUpdateMedicine" method="get">
                             <input type="hidden" name="Appointmentid" value="${result.appointmentID}" />
                            <input type="hidden" name="id" value="${result.resultID}" />
                            <button type="submit" class="btn btn-primary">View Medicine</button>
                        </form>
        ...
        <script>
            function doEditMedicine(resultID) {
                var url = "viewAndUpdateMedicine.jsp?resultID=" + resultID;
                window.location.href = url;
            }

            function doEditMedicineFromHeader() {
                // This function can be used to handle the Edit Medicine button in the header
                alert('This button can be linked to a relevant action or page.');
            }
        </script>
    </body>
</html>
